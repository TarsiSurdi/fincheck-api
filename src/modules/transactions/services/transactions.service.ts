...
export class TransactionsService {
  constructor(
    ...
    private readonly validateCategoriesOwnership: ValidateCategoryOwnershipService,
    private readonly validateTransactionsOwnership: ValidateTransactionOwnershipService,
  ) {}
  ...
  private async validateEntitiesOwnership({
    ...
    await Promise.all([
      transactionId &&
        this.validateTransactionsOwnership.validate(userId, transactionId),
      bankAccountId &&
